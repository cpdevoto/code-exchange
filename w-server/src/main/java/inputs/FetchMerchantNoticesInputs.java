...
@JsonDeserialize(builder = FetchMerchantNoticesInputs.Builder.class)
public class FetchMerchantNoticesInputs {
  @NotNull
  ...
  public static Builder builder(FetchMerchantNoticesInputs inputs) {
    return new Builder(inputs);
  }

  private FetchMerchantNoticesInputs(Builder builder) {
  ...
  public static class Builder {
    ...
    private Builder(FetchMerchantNoticesInputs inputs) {
    ...
    public FetchMerchantNoticesInputs build() {
      return new FetchMerchantNoticesInputs(this);
    }
  }
}
