...
import static utils.http.HttpUtilsHelper.MAPPER;
...
public abstract class AbstractHttpRequest<R extends AbstractHttpRequest<R>>
  ...
  public <T> R put(T value) throws JsonProcessingException {
    requireNonNull(value, "value cannot be null");
    this.buildRequestHandlers.add(builder -> {
      builder.put(value);
    });
