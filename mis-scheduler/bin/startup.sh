...
#
# Start the MIS Scheduler Engine
#
...
EXTRA_OPTS="-Dlog.extra.appender=FILE $MEM_OPTS -Dlog.sfx=_alert_$$ -Dcom.sun.management.jmxremote.port=$JMX_PORT -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false"
